...
The training series is divided into **8 main sections** containing **27 highly focused modules**, **26 targeted lab sandboxes**, and **8 comprehensive Section Capstone Challenges**:
...
| | [M6: Service Debugging (systemctl & journalctl)](sections/section-010/module-06/course.md) | _lab pending_ | _—_ |
