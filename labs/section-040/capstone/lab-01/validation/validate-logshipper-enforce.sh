...
if ! systemctl is-active --quiet logshipper; then
  echo "FAIL: logshipper.service is not active"
  exit 1
fi

echo "PASS: logshipper's AppArmor profile is loaded and genuinely enforcing"
exit 0
