# Lab 064: DNF Package Information Lookup Sandbox
...
Because this lab is read-only, you'll record your research findings into a few small answer files inside the container (see `docs/question.md` for exact paths) so your work has a concrete, checkable record.
