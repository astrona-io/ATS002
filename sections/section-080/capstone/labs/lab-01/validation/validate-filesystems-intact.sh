...
check_partition "$P1" "vdc1 original data - LFCS lab-080, do not lose me" /mnt/lab080-check1 || exit 1
check_partition "$P2" "vdc2 original data - LFCS lab-080, do not lose me" /mnt/lab080-check2 || exit 1
