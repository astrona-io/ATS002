# AppArmor Profile Enforcement {{title}} the Other MAC System: SELinux — Playground

- **ID:** PLAYGROUND
- **Slug:** apparmor-mac-enforcement
...
`astrona destroy` takes the environment name (`metadata.name` = `apparmor-mac-enforcement`), not
